  ...
  return (
    <div className="my-10">
      ...
      <div className="flex flex-col gap-2">
        <p>
          Hey! I&apos;am Juan, a law and computer science student that loves
          code. Now I&apos;m center in Web 3 development (Solidity mostly) but
          constantly I&apos;m learning about backend with Node.js (I like{" "}
          <ExternalLink content="Nest" href="https://docs.nestjs.com/" />
          ).
        </p>
        <p>
          What about Frontend may you be thinking? Well, I just need everything
          looks so good. So I learned CSS until I knew{" "}
